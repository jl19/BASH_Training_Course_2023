...
>:memo: > -  Understand the basics of the NGS technologies     
...
| ----------- | --------------|------------|--------------------------------------------------|
| [Fasta](https://www.bioinformatics.nl/tools/crab_fasta.html)    | .fasta, .fa   |sequences   |txt file for nucleotie or peptie sequences       |
